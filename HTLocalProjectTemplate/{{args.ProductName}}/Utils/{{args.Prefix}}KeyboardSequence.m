//
//  {{args.Prefix}}KeyboardSequence.m
//  {{args.ProductName}}
//
...
@interface {{args.Prefix}}KeyboardSequence () <UITextViewDelegate, UITextFieldDelegate>

@property (nonatomic, strong) NSMutableArray *textFieldsStack;

@end

@implementation {{args.Prefix}}KeyboardSequence
