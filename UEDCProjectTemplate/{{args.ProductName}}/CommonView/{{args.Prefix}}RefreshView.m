...
- (void)layoutSubviews {
    ...
    _containerView.middleX = SCREEN_WIDTH / 2;
    _containerView.middleY = (self.height + 15) / 2;
    
    _loadingIndicator.middleX = _containerView.width/2;
    _loadingIndicator.y = 0;
    
    _indicateLabel.middleX = _containerView.width/2;
    _indicateLabel.y = _loadingIndicator.bottom + 5;
}
