...
- (void)layoutSubviews {
    ...
    _dotBadgeView.middleX = _iconImageView.tail - kDotBadgeWidth/2;;
    
    _badgeView.size = CGSizeMake(kBadgeWidth, kBadgeHeight);
    _badgeView.y = kBadgeTopMargin;
    _badgeView.middleX = _iconImageView.tail;
}
...
- (void)showBadge:({{args.Prefix}}BadgeType)badgeType text:(NSString*)text {
    ...
    if (badgeType == {{args.Prefix}}BadgeTypeText){
        ...
        _dotBadgeView.backgroundColor = [UIColor colorWithRGBValue:kTabBarBadgebackgroundColor];
