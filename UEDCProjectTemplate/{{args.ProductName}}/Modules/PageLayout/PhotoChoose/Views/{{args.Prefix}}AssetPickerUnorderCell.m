//
//  {{args.Prefix}}AssetPickerUnorderCell.m
//  {{args.Prefix}}
//
...
@interface {{args.Prefix}}AssetPickerUnorderCell () <HTAssetPickerCellDelegate>
{
...
@implementation {{args.Prefix}}AssetPickerUnorderCell
