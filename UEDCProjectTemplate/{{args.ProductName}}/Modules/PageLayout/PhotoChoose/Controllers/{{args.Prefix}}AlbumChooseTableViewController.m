//
//  {{args.Prefix}}AlbumChooseTableViewController.m
//  {{args.Prefix}}
//
...
#import "{{args.Prefix}}AlbumChooseTableViewController.h"
#import <AssetsLibrary/AssetsLibrary.h>

@interface {{args.Prefix}}AlbumChooseTableViewController ()

@end

@implementation {{args.Prefix}}AlbumChooseTableViewController
...
{
    static NSString* cellIdentifier = @"{{args.Prefix}}TableAlbumChooserCellIdentifier";
