//
//  {{args.Prefix}}ShareCollectionViewCell.m
//  {{args.Prefix}}
//
...
@interface {{args.Prefix}}ShareCollectionViewCell ()
...
@implementation {{args.Prefix}}ShareCollectionViewCell
...
- (void)setData:({{args.Prefix}}ShareContentData *)data{
    _data = data;
