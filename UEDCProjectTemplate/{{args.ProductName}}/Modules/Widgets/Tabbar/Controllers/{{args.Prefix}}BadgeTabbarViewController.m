//
//  {{args.Prefix}}BadgeTabbarViewController.m
//
//  Created by {{args.Author}} on 2017/5/10.
//    Copyright © 2017年 Netease. All rights reserved.
//

#import "{{args.Prefix}}BadgeTabbarViewController.h"
...
@implementation {{args.Prefix}}BadgeTabbarViewController
...
+ (NSString*)urlPath {
    return @"{{args.Prefix}}://badgeTabBar";
}
...
- (void)loadBadges{
    [self showBadge:{{args.Prefix}}BadgeTypeText text:@"28" atIndex:0];
    [self showBadge:{{args.Prefix}}BadgeTypeDot text:nil atIndex:1];
}
