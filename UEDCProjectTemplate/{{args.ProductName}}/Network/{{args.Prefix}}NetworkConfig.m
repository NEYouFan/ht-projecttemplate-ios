...
static NSString *const k{{args.Prefix}}DevBaseURL = @"https://{{args.Prefix}}.dev.com";
static NSString *const k{{args.Prefix}}OnlineBaseURL = @"https://{{args.Prefix}}.online.com";
static NSString *const k{{args.Prefix}}PreBaseURL = @"https://{{args.Prefix}}.pre.com";
