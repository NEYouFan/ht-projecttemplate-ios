...
/// 一级标题字体大小
extern const CGFloat kFirstClassTitleFontSize;
/// 二级标题字体大小
extern const CGFloat kSecondClassTitleFontSize;
/// 一级正文字体大小
extern const CGFloat kFirstClassContentFontSize;
/// 二级正文字体大小
extern const CGFloat kSecondClassContentFontSize;
/// 三级正文字体大小
extern const CGFloat kThirdClassContentFontSize;


/* *************** 输入框字体(通常由视觉统一规范规定)相关, 可根据所需自由添加 *********/

/// 输入框的提示字体大小
extern const CGFloat kPlaceholderFontSize;

/* *************** button字体(通常由视觉统一规范规定)相关, 可根据所需自由添加 *********/

///默认button字体的大小
extern const CGFloat kDefaultButtonTitleFontSize;

/* ********************* 通知字体(通常由视觉统一规范规定)相关, 可根据所需自由添加 *************************/

extern const CGFloat kNotificationSrcollTextFontSize;

/* *************** alertView字体(通常由视觉统一规范规定)相关, 可根据所需自由添加 *********/
extern const CGFloat kAlertViewTitleFontSize;
extern const CGFloat kAlertViewContentFontSize;
extern const CGFloat kAlertViewButtonTitleFontSize;
...
/// 导航栏返回字体大小
extern const CGFloat kNaviLeftButtonTextFontSize;
/// 导航栏右侧按钮字体大小
extern const CGFloat kNaviRightButtonTextFontSize;
...
/// tab 图标宽度
extern const CGFloat kTabIconWitdh;
/// tab 图标高度
extern const CGFloat kTabIconHeight;
...
/* ********************* 与pageControllerView相关的字体和布局参数 *************************/

/// pageControllerView视图的高度
extern const CGFloat kPageControllerViewHeight;
/// pageControllerView字体大小
extern const CGFloat kPageControllerViewFont;
/// 导航栏SegmentsCell字体大小
extern const CGFloat kNaviSegmentsCellTextFont;
/// 导航栏segmentCell的宽度
extern const CGFloat kNaviSegmentsCellWitdh;
/// 导航栏segmentCell的高度
extern const CGFloat kNaviSegmentsCellHeight;
...
/// 加载为空、加载出错页面的Icon的大小
extern const CGFloat kLoadingIconWidth;
extern const CGFloat kLoadingIconHeight;
...
/// 刷新重试按钮字体大小
extern const CGFloat kRetryButtonTitleFontSize;
